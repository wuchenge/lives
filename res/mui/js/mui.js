...
(function($, window, document) {
	...
	var CLASS_ICON_PASSWORD = 'mui-icon-eye iconkm icon-biyanjing';
	...
	Input.prototype.passwordActionClick = function(event) {
		...
		this.passwordAction.classList.toggle('iconkm');
		this.passwordAction.classList.toggle('icon-biyanjing');
		event.preventDefault();
	};
